...
public class GestorIncrementarBoletaCount
{
    ...
    public string IncrementarBoletaCountPorDNI(string dni)
    {
        try
        {
            using (SqlConnection conn = new SqlConnection(GetConnectionString()))
            {
                ...
                using (SqlCommand command = new SqlCommand("IncrementarBoletaCountPorDNI", conn))
                {
